...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base leading-snug font-[650] tracking-[-0.015em] group-data-[size=sm]/card:text-sm",
        className,
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-lg border-t bg-muted/65 p-(--card-spacing)",
        className,
      )}
      {...props}
    />
